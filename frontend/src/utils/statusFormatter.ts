...
export const getStatusColor = (status: string): string => {
    const colorMap: { [key: string]: string } = {
        ...
        'rejected': 'var(--error)',
        'blocked': 'var(--error)',
        'account_blocked': 'var(--error)',
        'terminated': 'var(--error)',
        'fraud_confirmed': 'var(--error)',
...
export const getStatusBackgroundColor = (status: string): string => {
    const bgMap: { [key: string]: string } = {
        ...
        'account_blocked': 'rgba(220, 38, 38, 0.2)',
        'terminated': 'rgba(220, 38, 38, 0.2)',
        'fraud_confirmed': 'rgba(220, 38, 38, 0.2)',
